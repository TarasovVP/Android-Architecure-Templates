package com.vnteam.architecturetemplates.screens.create
...
import com.vnteam.architecturetemplates.DEFAULT_DEMO_OBJECT_ID
...
fun CreateScreen(
    ...
    LaunchedEffect(Unit) {
        if (demoObjectId.isNotEmpty() && demoObjectId != DEFAULT_DEMO_OBJECT_ID) {
