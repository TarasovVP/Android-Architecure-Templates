...
@required
- (SharedRuntimeQuery<SharedForkWithOwner *> *)getForkWithOwnerByIdId:(int64_t)id __attribute__((swift_name("getForkWithOwnerById(id:)")));
- (SharedRuntimeQuery<id> *)getForkWithOwnerByIdId:(int64_t)id mapper:(id (^)(SharedLong *, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable, SharedLong * _Nullable, NSString * _Nullable))mapper __attribute__((swift_name("getForkWithOwnerById(id:mapper:)")));
- (SharedRuntimeQuery<SharedForkWithOwner *> *)getForkWithOwners __attribute__((swift_name("getForkWithOwners()")));
- (SharedRuntimeQuery<id> *)getForkWithOwnersMapper:(id (^)(SharedLong *, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable, SharedLong * _Nullable, NSString * _Nullable))mapper __attribute__((swift_name("getForkWithOwners(mapper:)")));
- (void)insertForkWithOwnerId:(SharedLong * _Nullable)id name:(NSString * _Nullable)name fullName:(NSString * _Nullable)fullName htmlUrl:(NSString * _Nullable)htmlUrl description:(NSString * _Nullable)description login:(NSString * _Nullable)login ownerId:(SharedLong * _Nullable)ownerId avatarUrl:(NSString * _Nullable)avatarUrl __attribute__((swift_name("insertForkWithOwner(id:name:fullName:htmlUrl:description:login:ownerId:avatarUrl:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForkWithOwner")))
@interface SharedForkWithOwner : SharedBase
- (instancetype)initWithId:(int64_t)id name:(NSString * _Nullable)name fullName:(NSString * _Nullable)fullName htmlUrl:(NSString * _Nullable)htmlUrl description:(NSString * _Nullable)description login:(NSString * _Nullable)login ownerId:(SharedLong * _Nullable)ownerId avatarUrl:(NSString * _Nullable)avatarUrl __attribute__((swift_name("init(id:name:fullName:htmlUrl:description:login:ownerId:avatarUrl:)"))) __attribute__((objc_designated_initializer));
- (SharedForkWithOwner *)doCopyId:(int64_t)id name:(NSString * _Nullable)name fullName:(NSString * _Nullable)fullName htmlUrl:(NSString * _Nullable)htmlUrl description:(NSString * _Nullable)description login:(NSString * _Nullable)login ownerId:(SharedLong * _Nullable)ownerId avatarUrl:(NSString * _Nullable)avatarUrl __attribute__((swift_name("doCopy(id:name:fullName:htmlUrl:description:login:ownerId:avatarUrl:)")));
...
@property (readonly) SharedLong * _Nullable ownerId __attribute__((swift_name("ownerId")));
@end
...
__attribute__((swift_name("ForkDao")))
@protocol SharedForkDao
@required
- (SharedForkWithOwner * _Nullable)getForkByIdId:(int64_t)id __attribute__((swift_name("getForkById(id:)")));
- (NSArray<SharedForkWithOwner *> *)getForks __attribute__((swift_name("getForks()")));
- (void)insertForkWithOwnersForks:(NSArray<SharedForkWithOwner *> *)forks __attribute__((swift_name("insertForkWithOwners(forks:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForkDaoImpl")))
@interface SharedForkDaoImpl : SharedBase <SharedForkDao>
- (instancetype)initWithAppDatabaseQueries:(id<SharedAppDatabaseQueries>)appDatabaseQueries __attribute__((swift_name("init(appDatabaseQueries:)"))) __attribute__((objc_designated_initializer));
- (SharedForkWithOwner * _Nullable)getForkByIdId:(int64_t)id __attribute__((swift_name("getForkById(id:)")));
- (NSArray<SharedForkWithOwner *> *)getForks __attribute__((swift_name("getForks()")));
- (void)insertForkWithOwnersForks:(NSArray<SharedForkWithOwner *> *)forks __attribute__((swift_name("insertForkWithOwners(forks:)")));
@end
...
@protocol SharedBaseMapper
@required
- (id _Nullable)mapFromImplModelTo:(id _Nullable)to __attribute__((swift_name("mapFromImplModel(to:)")));
- (NSArray<id> *)mapFromImplModelListToList:(NSArray<id> *)toList __attribute__((swift_name("mapFromImplModelList(toList:)")));
- (id _Nullable)mapToImplModelFrom:(id _Nullable)from __attribute__((swift_name("mapToImplModel(from:)")));
- (NSArray<id> *)mapToImplModelListFromList:(NSArray<id> *)fromList __attribute__((swift_name("mapToImplModelList(fromList:)")));
@end

__attribute__((swift_name("ForkDBMapper")))
@protocol SharedForkDBMapper <SharedBaseMapper>
@required
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForkDBMapperImpl")))
@interface SharedForkDBMapperImpl : SharedBase <SharedForkDBMapper>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (SharedFork *)mapFromImplModelTo:(SharedForkWithOwner *)to __attribute__((swift_name("mapFromImplModel(to:)")));
- (NSArray<SharedFork *> *)mapFromImplModelListToList:(NSArray<SharedForkWithOwner *> *)toList __attribute__((swift_name("mapFromImplModelList(toList:)")));
- (SharedForkWithOwner *)mapToImplModelFrom:(SharedFork *)from __attribute__((swift_name("mapToImplModel(from:)")));
- (NSArray<SharedForkWithOwner *> *)mapToImplModelListFromList:(NSArray<SharedFork *> *)fromList __attribute__((swift_name("mapToImplModelList(fromList:)")));
@end

__attribute__((swift_name("ForkResponseMapper")))
@protocol SharedForkResponseMapper <SharedBaseMapper>
@required
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForkResponseMapperImpl")))
@interface SharedForkResponseMapperImpl : SharedBase <SharedForkResponseMapper>
- (instancetype)initWithOwnerResponseMapper:(id<SharedOwnerResponseMapper>)ownerResponseMapper __attribute__((swift_name("init(ownerResponseMapper:)"))) __attribute__((objc_designated_initializer));
- (SharedFork *)mapFromImplModelTo:(SharedForkResponse *)to __attribute__((swift_name("mapFromImplModel(to:)")));
- (NSArray<SharedFork *> *)mapFromImplModelListToList:(NSArray<SharedForkResponse *> *)toList __attribute__((swift_name("mapFromImplModelList(toList:)")));
- (SharedForkResponse *)mapToImplModelFrom:(SharedFork *)from __attribute__((swift_name("mapToImplModel(from:)")));
- (NSArray<SharedForkResponse *> *)mapToImplModelListFromList:(NSArray<SharedFork *> *)fromList __attribute__((swift_name("mapToImplModelList(fromList:)")));
@end

__attribute__((swift_name("OwnerResponseMapper")))
@protocol SharedOwnerResponseMapper <SharedBaseMapper>
@required
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("OwnerResponseMapperImpl")))
@interface SharedOwnerResponseMapperImpl : SharedBase <SharedOwnerResponseMapper>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (SharedOwner *)mapFromImplModelTo:(SharedOwnerResponse *)to __attribute__((swift_name("mapFromImplModel(to:)")));
- (NSArray<SharedOwner *> *)mapFromImplModelListToList:(NSArray<SharedOwnerResponse *> *)toList __attribute__((swift_name("mapFromImplModelList(toList:)")));
- (SharedOwnerResponse *)mapToImplModelFrom:(SharedOwner *)from __attribute__((swift_name("mapToImplModel(from:)")));
- (NSArray<SharedOwnerResponse *> *)mapToImplModelListFromList:(NSArray<SharedOwner *> *)fromList __attribute__((swift_name("mapToImplModelList(fromList:)")));
@end
...
*/
- (void)getForksWithCompletionHandler:(void (^)(SharedKtor_client_coreHttpResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getForks(completionHandler:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("NetworkResultFailure")))
@interface SharedNetworkResultFailure : SharedNetworkResult<SharedKotlinNothing *>
- (instancetype)initWithErrorMessage:(NSString * _Nullable)errorMessage __attribute__((swift_name("init(errorMessage:)"))) __attribute__((objc_designated_initializer));
- (SharedNetworkResultFailure *)doCopyErrorMessage:(NSString * _Nullable)errorMessage __attribute__((swift_name("doCopy(errorMessage:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForkResponse")))
@interface SharedForkResponse : SharedBase
- (instancetype)initWithId:(SharedLong * _Nullable)id name:(NSString * _Nullable)name fullName:(NSString * _Nullable)fullName owner:(SharedOwnerResponse * _Nullable)owner htmlUrl:(NSString * _Nullable)htmlUrl description:(NSString * _Nullable)description __attribute__((swift_name("init(id:name:fullName:owner:htmlUrl:description:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedForkResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedForkResponse *)doCopyId:(SharedLong * _Nullable)id name:(NSString * _Nullable)name fullName:(NSString * _Nullable)fullName owner:(SharedOwnerResponse * _Nullable)owner htmlUrl:(NSString * _Nullable)htmlUrl description:(NSString * _Nullable)description __attribute__((swift_name("doCopy(id:name:fullName:owner:htmlUrl:description:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
*/
@property NSString * _Nullable htmlUrl __attribute__((swift_name("htmlUrl")));
@property SharedLong * _Nullable id __attribute__((swift_name("id")));
@property NSString * _Nullable name __attribute__((swift_name("name")));
@property SharedOwnerResponse * _Nullable owner __attribute__((swift_name("owner")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForkResponse.Companion")))
@interface SharedForkResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedForkResponseCompanion *shared __attribute__((swift_name("shared")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("OwnerResponse")))
@interface SharedOwnerResponse : SharedBase
- (instancetype)initWithLogin:(NSString * _Nullable)login ownerId:(SharedLong * _Nullable)ownerId avatarUrl:(NSString * _Nullable)avatarUrl __attribute__((swift_name("init(login:ownerId:avatarUrl:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedOwnerResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedOwnerResponse *)doCopyLogin:(NSString * _Nullable)login ownerId:(SharedLong * _Nullable)ownerId avatarUrl:(NSString * _Nullable)avatarUrl __attribute__((swift_name("doCopy(login:ownerId:avatarUrl:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
*/
@property SharedLong * _Nullable ownerId __attribute__((swift_name("ownerId")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("OwnerResponse.Companion")))
@interface SharedOwnerResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedOwnerResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((swift_name("ApiRepository")))
@protocol SharedApiRepository
@required
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getForksFromApiWithCompletionHandler:(void (^)(id<SharedKotlinx_coroutines_coreFlow> _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getForksFromApi(completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiRepositoryImpl")))
@interface SharedApiRepositoryImpl : SharedBase <SharedApiRepository>
- (instancetype)initWithApiService:(SharedApiService *)apiService forkResponseMapper:(id<SharedForkResponseMapper>)forkResponseMapper __attribute__((swift_name("init(apiService:forkResponseMapper:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((swift_name("DBRepository")))
@protocol SharedDBRepository
@required
- (id<SharedKotlinx_coroutines_coreFlow>)getForkByIdForkId:(int64_t)forkId __attribute__((swift_name("getForkById(forkId:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)getForksFromDB __attribute__((swift_name("getForksFromDB()")));
- (void)insertForksToDBForks:(NSArray<SharedFork *> *)forks __attribute__((swift_name("insertForksToDB(forks:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DBRepositoryImpl")))
@interface SharedDBRepositoryImpl : SharedBase <SharedDBRepository>
- (instancetype)initWithForkDao:(id<SharedForkDao>)forkDao forkDBMapper:(id<SharedForkDBMapper>)forkDBMapper __attribute__((swift_name("init(forkDao:forkDBMapper:)"))) __attribute__((objc_designated_initializer));
- (id<SharedKotlinx_coroutines_coreFlow>)getForkByIdForkId:(int64_t)forkId __attribute__((swift_name("getForkById(forkId:)")));
- (id<SharedKotlinx_coroutines_coreFlow>)getForksFromDB __attribute__((swift_name("getForksFromDB()")));
- (void)insertForksToDBForks:(NSArray<SharedFork *> *)forks __attribute__((swift_name("insertForksToDB(forks:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Fork")))
@interface SharedFork : SharedBase
- (instancetype)initWithId:(SharedLong * _Nullable)id name:(NSString * _Nullable)name fullName:(NSString * _Nullable)fullName owner:(SharedOwner * _Nullable)owner htmlUrl:(NSString * _Nullable)htmlUrl description:(NSString * _Nullable)description __attribute__((swift_name("init(id:name:fullName:owner:htmlUrl:description:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedForkCompanion *companion __attribute__((swift_name("companion")));
- (SharedFork *)doCopyId:(SharedLong * _Nullable)id name:(NSString * _Nullable)name fullName:(NSString * _Nullable)fullName owner:(SharedOwner * _Nullable)owner htmlUrl:(NSString * _Nullable)htmlUrl description:(NSString * _Nullable)description __attribute__((swift_name("doCopy(id:name:fullName:owner:htmlUrl:description:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (setter=setDescription:) NSString * _Nullable description_ __attribute__((swift_name("description_")));
...
@property SharedLong * _Nullable id __attribute__((swift_name("id")));
@property NSString * _Nullable name __attribute__((swift_name("name")));
@property SharedOwner * _Nullable owner __attribute__((swift_name("owner")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Fork.Companion")))
@interface SharedForkCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedForkCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (instancetype)initWithLogin:(NSString * _Nullable)login ownerId:(SharedLong * _Nullable)ownerId avatarUrl:(NSString * _Nullable)avatarUrl __attribute__((swift_name("init(login:ownerId:avatarUrl:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedOwnerCompanion *companion __attribute__((swift_name("companion")));
- (SharedOwner *)doCopyLogin:(NSString * _Nullable)login ownerId:(SharedLong * _Nullable)ownerId avatarUrl:(NSString * _Nullable)avatarUrl __attribute__((swift_name("doCopy(login:ownerId:avatarUrl:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Owner.Companion")))
@interface SharedOwnerCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedOwnerCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((swift_name("ForkUseCase")))
@protocol SharedForkUseCase
@required
- (id<SharedKotlinx_coroutines_coreFlow>)getForkByIdForkId:(int64_t)forkId __attribute__((swift_name("getForkById(forkId:)")));
...
__attribute__((swift_name("DetailsIntent")))
@interface SharedDetailsIntent : SharedBase
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DetailsIntent.LoadFork")))
@interface SharedDetailsIntentLoadFork : SharedDetailsIntent
- (instancetype)initWithForkId:(int64_t)forkId __attribute__((swift_name("init(forkId:)"))) __attribute__((objc_designated_initializer));
- (SharedDetailsIntentLoadFork *)doCopyForkId:(int64_t)forkId __attribute__((swift_name("doCopy(forkId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DetailsViewState")))
@interface SharedDetailsViewState : SharedBase
- (instancetype)initWithFork:(SharedForkUI * _Nullable)fork isLoading:(BOOL)isLoading error:(NSString * _Nullable)error __attribute__((swift_name("init(fork:isLoading:error:)"))) __attribute__((objc_designated_initializer));
- (SharedDetailsViewState *)doCopyFork:(SharedForkUI * _Nullable)fork isLoading:(BOOL)isLoading error:(NSString * _Nullable)error __attribute__((swift_name("doCopy(fork:isLoading:error:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable error __attribute__((swift_name("error")));
@property (readonly) SharedForkUI * _Nullable fork __attribute__((swift_name("fork")));
@property (readonly) BOOL isLoading __attribute__((swift_name("isLoading")));
@end

__attribute__((swift_name("ListIntent")))
@interface SharedListIntent : SharedBase
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ListIntent.LoadForks")))
@interface SharedListIntentLoadForks : SharedListIntent
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ListViewState")))
@interface SharedListViewState : SharedBase
- (instancetype)initWithForks:(NSArray<SharedForkUI *> * _Nullable)forks isLoading:(BOOL)isLoading error:(NSString * _Nullable)error __attribute__((swift_name("init(forks:isLoading:error:)"))) __attribute__((objc_designated_initializer));
- (SharedListViewState *)doCopyForks:(NSArray<SharedForkUI *> * _Nullable)forks isLoading:(BOOL)isLoading error:(NSString * _Nullable)error __attribute__((swift_name("doCopy(forks:isLoading:error:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable error __attribute__((swift_name("error")));
@property (readonly) NSArray<SharedForkUI *> * _Nullable forks __attribute__((swift_name("forks")));
@property (readonly) BOOL isLoading __attribute__((swift_name("isLoading")));
@end

__attribute__((swift_name("ForkUIMapper")))
@protocol SharedForkUIMapper <SharedBaseMapper>
@required
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForkUIMapperImpl")))
@interface SharedForkUIMapperImpl : SharedBase <SharedForkUIMapper>
- (instancetype)initWithOwner:(id<SharedOwnerUIMapper>)owner __attribute__((swift_name("init(owner:)"))) __attribute__((objc_designated_initializer));
- (SharedFork *)mapFromImplModelTo:(SharedForkUI *)to __attribute__((swift_name("mapFromImplModel(to:)")));
- (NSArray<SharedFork *> *)mapFromImplModelListToList:(NSArray<SharedForkUI *> *)toList __attribute__((swift_name("mapFromImplModelList(toList:)")));
- (SharedForkUI *)mapToImplModelFrom:(SharedFork *)from __attribute__((swift_name("mapToImplModel(from:)")));
- (NSArray<SharedForkUI *> *)mapToImplModelListFromList:(NSArray<SharedFork *> *)fromList __attribute__((swift_name("mapToImplModelList(fromList:)")));
@end

__attribute__((swift_name("OwnerUIMapper")))
@protocol SharedOwnerUIMapper <SharedBaseMapper>
@required
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("OwnerUIMapperImpl")))
@interface SharedOwnerUIMapperImpl : SharedBase <SharedOwnerUIMapper>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (SharedOwner *)mapFromImplModelTo:(SharedOwnerUI *)to __attribute__((swift_name("mapFromImplModel(to:)")));
- (NSArray<SharedOwner *> *)mapFromImplModelListToList:(NSArray<SharedOwnerUI *> *)toList __attribute__((swift_name("mapFromImplModelList(toList:)")));
- (SharedOwnerUI *)mapToImplModelFrom:(SharedOwner *)from __attribute__((swift_name("mapToImplModel(from:)")));
- (NSArray<SharedOwnerUI *> *)mapToImplModelListFromList:(NSArray<SharedOwner *> *)fromList __attribute__((swift_name("mapToImplModelList(fromList:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForkUI")))
@interface SharedForkUI : SharedBase
- (instancetype)initWithId:(SharedLong * _Nullable)id name:(NSString * _Nullable)name fullName:(NSString * _Nullable)fullName owner:(SharedOwnerUI * _Nullable)owner htmlUrl:(NSString * _Nullable)htmlUrl description:(NSString * _Nullable)description __attribute__((swift_name("init(id:name:fullName:owner:htmlUrl:description:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedForkUICompanion *companion __attribute__((swift_name("companion")));
- (SharedForkUI *)doCopyId:(SharedLong * _Nullable)id name:(NSString * _Nullable)name fullName:(NSString * _Nullable)fullName owner:(SharedOwnerUI * _Nullable)owner htmlUrl:(NSString * _Nullable)htmlUrl description:(NSString * _Nullable)description __attribute__((swift_name("doCopy(id:name:fullName:owner:htmlUrl:description:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (setter=setDescription:) NSString * _Nullable description_ __attribute__((swift_name("description_")));
...
@property SharedLong * _Nullable id __attribute__((swift_name("id")));
@property NSString * _Nullable name __attribute__((swift_name("name")));
@property SharedOwnerUI * _Nullable owner __attribute__((swift_name("owner")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForkUI.Companion")))
@interface SharedForkUICompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedForkUICompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("OwnerUI")))
@interface SharedOwnerUI : SharedBase
- (instancetype)initWithLogin:(NSString * _Nullable)login ownerId:(SharedLong * _Nullable)ownerId avatarUrl:(NSString * _Nullable)avatarUrl __attribute__((swift_name("init(login:ownerId:avatarUrl:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedOwnerUICompanion *companion __attribute__((swift_name("companion")));
- (SharedOwnerUI *)doCopyLogin:(NSString * _Nullable)login ownerId:(SharedLong * _Nullable)ownerId avatarUrl:(NSString * _Nullable)avatarUrl __attribute__((swift_name("doCopy(login:ownerId:avatarUrl:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSString * _Nullable avatarUrl __attribute__((swift_name("avatarUrl")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("OwnerUI.Companion")))
@interface SharedOwnerUICompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedOwnerUICompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ForkUseCaseImpl")))
@interface SharedForkUseCaseImpl : SharedBase <SharedForkUseCase>
- (instancetype)initWithApiRepository:(id<SharedApiRepository>)apiRepository dbRepository:(id<SharedDBRepository>)dbRepository __attribute__((swift_name("init(apiRepository:dbRepository:)"))) __attribute__((objc_designated_initializer));
- (id<SharedKotlinx_coroutines_coreFlow>)getForkByIdForkId:(int64_t)forkId __attribute__((swift_name("getForkById(forkId:)")));
...
- (instancetype)initWithSize:(float)size textSize:(int64_t)textSize __attribute__((swift_name("init(size:textSize:)"))) __attribute__((objc_designated_initializer));
- (SharedDimens *)doCopySize:(float)size textSize:(int64_t)textSize __attribute__((swift_name("doCopy(size:textSize:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSString *IC_PERSON __attribute__((swift_name("IC_PERSON")));
@end
...
@property (readonly) NSString *BACK __attribute__((swift_name("BACK")));
@property NSString *OWNER_AVATAR __attribute__((swift_name("OWNER_AVATAR")));
...
@interface SharedKtor_client_coreHttpResponse (Extensions)

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)handleResponseWithCompletionHandler:(void (^)(SharedNetworkResult<id> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("handleResponse(completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AppModuleKt")))
@interface SharedAppModuleKt : SharedBase
@property (class, readonly) SharedKoin_coreModule *appModule __attribute__((swift_name("appModule")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TypographyKt")))
@interface SharedTypographyKt : SharedBase
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (SharedFloat *)next_ __attribute__((swift_name("next_()")));
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (SharedInt *)next_ __attribute__((swift_name("next_()")));
...
- (BOOL)hasNext __attribute__((swift_name("hasNext()")));
- (SharedSkikoPathSegment * _Nullable)next_ __attribute__((swift_name("next_()")));
- (void)remove __attribute__((swift_name("remove()")));
