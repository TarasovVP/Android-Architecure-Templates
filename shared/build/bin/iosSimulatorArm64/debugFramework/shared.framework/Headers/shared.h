...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PlatformMessageDisplayer")))
@interface SharedPlatformMessageDisplayer : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)setUIViewControllerUiViewController:(UIViewController *)uiViewController __attribute__((swift_name("setUIViewController(uiViewController:)")));
- (void)showPopupMessageMessage:(NSString *)message __attribute__((swift_name("showPopupMessage(message:)")));
@end
