...
class ApiRepositoryTest : BaseKoinTest() {
    ...
    @Test
    fun testGetDemoObjectsSuccessful() =
        runTest {
    ...
    @Test
    fun testInsertDemoObjectsSuccessful() =
        runTest {
    ...
    @Test
    fun testInsertDemoObjectsFailed() =
        runTest {
            apiService.isSuccessful = false
            val exception =
                assertFailsWith<Exception> {
    ...
    @Test
    fun testGetDemoObjectByIdSuccessful() =
        runTest {
            apiService.demoObjectsResponse = fakeDemoObjectsResponse
    ...
    @Test
    fun testGetDemoObjectByIdFailed() =
        runTest {
            apiService.isSuccessful = false
            val exception =
                assertFailsWith<Exception> {
    ...
    @Test
    fun testDeleteDemoObjectByIdSuccessful() =
        runTest {
            apiService.demoObjectsResponse = fakeDemoObjectsResponse
    ...
    @Test
    fun testDeleteDemoObjectByIdFailed() =
        runTest {
            apiService.isSuccessful = false
            val exception =
                assertFailsWith<Exception> {
