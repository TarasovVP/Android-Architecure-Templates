...
class PreferencesRepositoryImpl(
    private val preferencesFactory: Preferences,
) : PreferencesRepository {
    override suspend fun setIsDarkTheme(isDarkTheme: Boolean) {
        preferencesFactory.putBoolean(IS_DARK_THEME, isDarkTheme)
    }

    override fun getIsDarkTheme(): Flow<Boolean> = preferencesFactory.getBoolean(IS_DARK_THEME)

    override suspend fun setLanguage(language: String) {
        preferencesFactory.putString(APP_LANGUAGE, language)
    }

    override fun getLanguage(): Flow<String?> = preferencesFactory.getString(APP_LANGUAGE)
}
